...
* [**Measure Repository**](measure-repository-service.html) Use cases depicted in this IG are expected to use a terminology service conformant with the [Artifact Terminology Service Capabilities]({{site.data.fhir.ver.crmi}}/artifact-terminology-service.html) as defined in CRMI. See [Measure Conformance Manifest](measure-conformance.html#manifest) regarding the use of the [CRMI Manifest Library]({{site.data.fhir.ver.crmi}}/StructureDefinition-crmi-manifestlibrary.html).

Use cases depicted in this IG are expected to use a terminology service conformant with the [Artifact Terminology Service Capabilities as defined in CRMI.]({{site.data.fhir.ver.crmi}}/artifact-terminology-service.html)

In addition, the following example capability statement illustrates the use of the [cqf-supportedCqlVersion]({{site.data.fhir.ver.ext}}/StructureDefinition-cqf-supportedCqlVersion.html) extension to support advertising the version of CQL supported by the service:
