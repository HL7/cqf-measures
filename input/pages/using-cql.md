...
1. If the library has function overloads (i.e. function definitions with the same name and different argument lists), the ELM SHALL <span class="bg-success">be</span> translated with a SignatureLevel other than `None`
