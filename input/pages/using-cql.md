...
CQL can be used with any data model. In the context of a Measure, any referenced CQL library must identify the same data model. Additional information can be found here: https://hl7.org/fhir/uv/cql/2024Jan/using-cql.html#data-model
