...
CQL can be used with any data model. In the context of a Measure, any referenced CQL library must identify the same data model. Additional information can be found in the [Using CQL with FHIR IG]({{site.data.fhir.ver.cql}}/using-cql.html#data-model).
