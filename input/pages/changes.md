...
* **Applied**: Adding a link on USING CQL page for data model information([FHIR-45389](https://jira.hl7.org/browse/FHIR-45389))([Applied here]())
...
* **Applied**: Editorial corrections to opening sentence([FHIR-45435](https://jira.hl7.org/browse/FHIR-45435))([Applied here]())
* **Applied**: Remove conformance requirement 6.5([FHIR-45438](https://jira.hl7.org/browse/FHIR-45438))([Applied here]())
* **Applied**: Fix link to Adapting Guidelines for the Digital Age([FHIR-45463](https://jira.hl7.org/browse/FHIR-45463))([Applied here]())
* **Applied**: Fix link to Adapting Guidelines for the Digital Age - another location([FHIR-45464](https://jira.hl7.org/browse/FHIR-45464))([Applied here]())
* **Applied**: Remove reference to the Measure Authoring Tool (MAT)([FHIR-45465](https://jira.hl7.org/browse/FHIR-45465))([Applied here]())
* **Applied**: Align description of words - episode of care vs. non-patient based vs. encounter-based measure throughout IG([FHIR-45466](https://jira.hl7.org/browse/FHIR-45466))([Applied here]())
* **Applied**: Better align graphic with text. Step 2 is clinical practice guidelines([FHIR-45558](https://jira.hl7.org/browse/FHIR-45558))([Applied here]())
* **Applied**: There is reference to a ghost Figure 2-1 in this section.([FHIR-45560](https://jira.hl7.org/browse/FHIR-45560))([Applied here]())
* **Applied**: Missing the word "to"([FHIR-45562](https://jira.hl7.org/browse/FHIR-45562))([Applied here]())
* **Applied**: Formatting includes extra white space and spacing issues([FHIR-45563](https://jira.hl7.org/browse/FHIR-45563))([Applied here]())
* **Applied**: Does this need clarification for users who are not experts in quality measures? Link to resource or definition([FHIR-45565](https://jira.hl7.org/browse/FHIR-45565))([Applied here]())
* **Applied**: can this link out to the eCQM RC([FHIR-45567](https://jira.hl7.org/browse/FHIR-45567))([Applied here]())
* **Applied**: Awareness is confusing.([FHIR-45568](https://jira.hl7.org/browse/FHIR-45568))([Applied here]())
* **Applied**: Can links be created([FHIR-45570](https://jira.hl7.org/browse/FHIR-45570))([Applied here]())
* **Applied**: Cannot find header data elements([FHIR-45571](https://jira.hl7.org/browse/FHIR-45571))([Applied here]())
* **Applied**: Documentation Flow([FHIR-45572](https://jira.hl7.org/browse/FHIR-45572))([Applied here]())
* **Applied**: Correction is Steps in section 1.3.1([FHIR-45573](https://jira.hl7.org/browse/FHIR-45573))([Applied here]())
* **Applied**: Suggestion to link to the CQFMCohortMeasure profile([FHIR-45574](https://jira.hl7.org/browse/FHIR-45574))([Applied here]())
...
* **Applied**: Note to Ballot Reviewers Regarding When, Where and How to report([FHIR-45636](https://jira.hl7.org/browse/FHIR-45636))([Applied here]())
* **Applied**: Misspells, Typos, Duplicates, Broken Links, Incomplete Sentences, Inconsistent Punctuation, Etcetera([FHIR-45643](https://jira.hl7.org/browse/FHIR-45643))([Applied here]())
* **Applied**: Technical Correction([FHIR-45692](https://jira.hl7.org/browse/FHIR-45692))([Applied here]())
...
* **Applied**: Remove the requirement that URL tail match the name element([FHIR-45881](https://jira.hl7.org/browse/FHIR-45881))([Applied here]())
* **Applied**: Remove the dependency on QICore ([FHIR-45882](https://jira.hl7.org/browse/FHIR-45882))([Applied here]())
* **Applied**: Correct links to Using CQL With FHIR IG([FHIR-45885](https://jira.hl7.org/browse/FHIR-45885))([Applied here]())
...
* **Applied**: Update terminology guidance ([FHIR-45887](https://jira.hl7.org/browse/FHIR-45887))([Applied here]())
* **Applied**: Consider updating the CQFCommon dependency ([FHIR-45888](https://jira.hl7.org/browse/FHIR-45888))([Applied here]())
...
* **Applied**: Consider revising packaging discussion ([FHIR-45891](https://jira.hl7.org/browse/FHIR-45891))([Applied here]())
* **Applied**: edits/comments to Introduction, QMs, and Using CQL pages ([FHIR-45905](https://jira.hl7.org/browse/FHIR-45905))([Applied here]())
...
* **Applied**: Consider referencing the conformance requirements ([FHIR-45915](https://jira.hl7.org/browse/FHIR-45915))([Applied here]())
* **Applied**:  Sync up short description and measure profile type ([FHIR-45916](https://jira.hl7.org/browse/FHIR-45916))([Applied here](StructureDefinition-cohort-measure-cqfm.html)) and ([Applied here](StructureDefinition-composite-measure-cqfm.html)) and ([Applied here](StructureDefinition-cv-measure-cqfm.html)) and ([Applied here](StructureDefinition-proportion-measure-cqfm.html)) and ([Applied here](StructureDefinition-ratio-measure-cqfm.html))
* **Applied**: Software system device should be using CRMI ([FHIR-45917](https://jira.hl7.org/browse/FHIR-45917))([Applied here]())
...
* **Applied**: Measure Profiles "SEP" combination ([FHIR-45920](https://jira.hl7.org/browse/FHIR-45920))([Applied here]())
...
* **Applied**: Examples throughout seem to be rendered incorrectly? ([FHIR-45922](https://jira.hl7.org/browse/FHIR-45922))([Applied here]())
...
* **Applied**: library profile usage ([FHIR-45924](https://jira.hl7.org/browse/FHIR-45924))([Applied here]())
* **Applied**: edits/comments to the Profiles page ([FHIR-45930](https://jira.hl7.org/browse/FHIR-45930))([Applied here]())
* **Applied**: Glossary page - minor edit to acronym ([FHIR-45932](https://jira.hl7.org/browse/FHIR-45932))([Applied here]())
...
* **Applied**: Add an attestation measure profile ([FHIR-46231](https://jira.hl7.org/browse/FHIR-46231)) ([Applied here]())
...
* **Applied**: clarify short description for appliesTo extension ([FHIR-46387](https://jira.hl7.org/browse/FHIR-46387))([Applied here]())
...
* **Applied**: Clarify the use of code-based stratifiers (including components) ([FHIR-47396](https://jira.hl7.org/browse/FHIR-47396))([Applied here]())
* **Applied**: CQMF Publishable Measure Profile Measure.status Fixed to Active ([FHIR-47767](https://jira.hl7.org/browse/FHIR-47767))([Applied here]())
* **Applied**: Support specifying intended venue for publishable measures ([FHIR-48533](https://jira.hl7.org/browse/FHIR-48533))([Applied here]())
