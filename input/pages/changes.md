...
* **Applied**: Inconsistent CQL version is referenced	([FHIR-43635](https://jira.hl7.org/browse/FHIR-43635))
* **Applied**: Update the mentioning of Da Vinci ATR	([FHIR-43636](https://jira.hl7.org/browse/FHIR-43636))
* **Applied**: Update version of CQL-based HQMF	([FHIR-43637](https://jira.hl7.org/browse/FHIR-43637))
* **Applied**: Incorrect library name in Snippet 3-1	([FHIR-43638](https://jira.hl7.org/browse/FHIR-43638))
* **Applied**: Issues with risk adjustment Snippet 3-28	([FHIR-43642](https://jira.hl7.org/browse/FHIR-43642))
* **Applied**: Context shown as unfiltered	([FHIR-43644](https://jira.hl7.org/browse/FHIR-43644))
* **Applied**: Denominator Exception	([FHIR-43645](https://jira.hl7.org/browse/FHIR-43645))
* **Applied**: Remove QRDA/QDM to an appendix	([FHIR-43682](https://jira.hl7.org/browse/FHIR-43682))
...
* **Applied**: Enhance the composite measure examples	([FHIR-43714](https://jira.hl7.org/browse/FHIR-43714))
* **Applied**: Add an example to help illustrate the difference between linear combination and opportunity scoring	([FHIR-43715](https://jira.hl7.org/browse/FHIR-43715))
* **Applied**: FHIR Version Support section out of date	([FHIR-43767](https://jira.hl7.org/browse/FHIR-43767))
* **Applied**: Data Model snippet out of sync with source file	([FHIR-43768](https://jira.hl7.org/browse/FHIR-43768))
* **Applied**: Introduction Purpose section has references to outdated versions	([FHIR-43771](https://jira.hl7.org/browse/FHIR-43771))
...
* **Applied**: use of "library bundles" in packaging measure section	([FHIR-43778](https://jira.hl7.org/browse/FHIR-43778))
...
* **Applied**: Make the background workflow more understandable	([FHIR-44070](https://jira.hl7.org/browse/FHIR-44070))
* **Applied**: Correct the Opportunity Scoring CQL example	([FHIR-44074](https://jira.hl7.org/browse/FHIR-44074))
* **Applied**: Correct example and conformance wording	([FHIR-44078](https://jira.hl7.org/browse/FHIR-44078))
* **Applied**: Missing periods	([FHIR-44118](https://jira.hl7.org/browse/FHIR-44118))
...
* **Applied**: Updated text for composite measures to explain mixed improvement notation	([FHIR-43693](https://jira.hl7.org/browse/FHIR-43693))
...
* **Not Yet Applied**: Canonical tail of Measure should be the name	([FHIR-43713](https://jira.hl7.org/browse/FHIR-43713))
* **Not Yet Applied**: Clarify ELM -> DataRequirements expectations	([FHIR-43781](https://jira.hl7.org/browse/FHIR-43781))
* **Not Yet Applied**: PopulationBasis extension description should refer to Measure.subject[x]	([FHIR-43782](https://jira.hl7.org/browse/FHIR-43782))
* **Not Yet Applied**: Element subject[x] should be must support in ComputableMeasure	([FHIR-43784](https://jira.hl7.org/browse/FHIR-43784))
* **Not Yet Applied**: Clarify the use of the valueFilter extension	([FHIR-43790](https://jira.hl7.org/browse/FHIR-43790))
* **Not Yet Applied**: Use the Extension Pack where possible	([FHIR-43969](https://jira.hl7.org/browse/FHIR-43969))
* **Not Yet Applied**: Comments Related to Note To Balloters	([FHIR-44125](https://jira.hl7.org/browse/FHIR-44125))
* **Not Yet Applied**: Code Systems and Valuesets should be anchored in THO (terminology.hl7.org). 5	([FHIR-44394](https://jira.hl7.org/browse/FHIR-44394))
* **Not Yet Applied**: Code Systems and Valuesets should be anchored in THO (terminology.hl7.org). 8	([FHIR-44399](https://jira.hl7.org/browse/FHIR-44399))
* **Not Yet Applied**: Code Systems and Valuesets should be anchored in THO (terminology.hl7.org). 10	([FHIR-44401](https://jira.hl7.org/browse/FHIR-44401))
* **Not Yet Applied**: Issues with conformance requirement 3.1 and measure profiles	([FHIR-44537](https://jira.hl7.org/browse/FHIR-44537))
* **Not Yet Applied**: Remove requirement to have ELM in a Library resource	([FHIR-44598](https://jira.hl7.org/browse/FHIR-44598))
* **Not Yet Applied**: Refactor Shareable and Publishable profiles and repositories to use CRMI	([FHIR-44642](https://jira.hl7.org/browse/FHIR-44642))
* **Not Yet Applied**: Addition Change for ImprovementNotation	([FHIR-44711](https://jira.hl7.org/browse/FHIR-44711))
* **Not Yet Applied**: Correct the url for CQL specification	([FHIR-44991](https://jira.hl7.org/browse/FHIR-44991))
