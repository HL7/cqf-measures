...
* **Applied**: Remove code "ep-ec" from Quality Programs value set	([FHIR-43323](https://jira.hl7.org/browse/FHIR-43323)) Applied ([here](https://hl7.org/fhir/uv/cqm/2024May/CodeSystem-quality-programs-example.html))
...
* **Applied**: Created an improvementNotationGuidance extension in the FHIR extensions pack and added to Publishable Measure at root and group level. ([FHIR-43463](https://jira.hl7.org/browse/FHIR-43463))([Applied here](https://hl7.org/fhir/uv/cqm/StructureDefinition-publishable-measure-cqfm.html))
...
* **Applied**: Updated the description of the Capabilities page on home page ([FHIR-43628](https://jira.hl7.org/browse/FHIR-43628))([Applied here](https://hl7.org/fhir/uv/cqm/2024Jan/#how-to-read-this-guide))
* **Applied**: Removed operations section from the capabilities page ([FHIR-43629](https://jira.hl7.org/browse/FHIR-43629))([Applied here](https://hl7.org/fhir/uv/cqm/2024Jan/capabilities.html))
...
* **Applied**: Updated CQL version references from 1.4 to 1.5.2 introduction, measure-conformance and using-cql pages  ([FHIR-43635](https://jira.hl7.org/browse/FHIR-43635))([Applied here](https://hl7.org/fhir/uv/cqm/introduction.html)), ([here](measure-conformance.html)), and ([here](using-cql.html))
...
* **Applied**: Incorrect library name in Snippet 3-1	([FHIR-43638](https://jira.hl7.org/browse/FHIR-43638))([Applied here](https://hl7.org/fhir/uv/cqm/2024May/measure-conformance.html#specifying-qms))
* **Applied**: Table 3.1 rendering is off	([FHIR-43640](https://jira.hl7.org/browse/FHIR-43640))([Applied here](https://hl7.org/fhir/uv/cqm/2024May/measure-conformance.html#specifying-qms))
...
* **Applied**: Updated the Quality Improvement Ecosystem paragraph to increase readability ([FHIR-44070](https://jira.hl7.org/browse/FHIR-44070))([Applied here](https://hl7.org/fhir/uv/cqm/2024Jan/#quality-improvement-ecosystem))
...
* **Applied**: Updated the text and image in data model standard landscape section to remove DEQM and HEDIS and replaced with Measure Content IG ([FHIR-44530](https://jira.hl7.org/browse/FHIR-44530))([Applied here](https://hl7.org/fhir/uv/cqm/2024Jan/#data-model-standards-landscape))
...
* **Applied**: Consider requiring the use of a SignatureLevel higher than none ([FHIR-42922](https://jira.hl7.org/browse/FHIR-42922))([Applied here](using-cql.html#translation-to-elm)), ([here](https://hl7.org/fhir/uv/cqm/2024May/using-cql.html#specifying-options)), and ([here](https://hl7.org/fhir/uv/cqm/2024May/using-cql.html#elm-suitability))
