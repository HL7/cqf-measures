...
1. FHIR-based eCQMs SHALL consist of a FHIR Measure resource conforming to at least the [CRMIShareableMeasure profile](https://build.fhir.org/ig/HL7/crmi-ig/branches/master/StructureDefinition-crmi-shareablemeasure.html). In addition, measures with a status of active SHALL conform to the [CQFMPublishableMeasure profile](https://build.fhir.org/ig/HL7/crmi-ig/StructureDefinition-crmi-publishablemeasure.html) in particular. FHIR-based measures SHALL contain a narrative containing a human-readable representation of the measure content.
