...
Except where noted, material from the base FHIR specification, and in particular the [Clinical Reasoning module](https://build.fhir.org/clinicalreasoning-module.html), is not repeated here.
